...
const (
	...
	NodeMarineTerminal   NodeKind = "marine_terminal"
...
const (
	...
	EdgeSeaborneCorridor EdgeKind = "seaborne_corridor"
...
type Edge struct {
	...
	VesselClass        string           `json:"vesselClass,omitempty"`
	State              OperationalState `json:"state"`
